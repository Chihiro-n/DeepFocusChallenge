...
def infer_only(model_dir: str):
    ...
    print("=" * 60)
    print("EXP017: Inference Only Mode")
    print("=" * 60)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='EXP017: Qwen3-VL LoRA Fine-tuning (v2+v5)')
    ...
    parser.add_argument('--model-dir', type=str, default=str(MODEL_DIR),
                        help='Model directory path (default: EXP/EXP017/outputs/models)')
